...
database at `2026-07-27T20:50:48.076890+00:00` (run 26), never an estimate.
...
|---|---|---|---|---|---|---|
| Knowledge Base | Data | Active | market_research_agent.py + keyword_agent.py | 86 keywords / 6032 signals | 100% (fully automated ingestion, no manual entry) | 2026-07-27 |
...
| Total raw signals collected | 6032 |

## Trend (last 7 run snapshot(s))
