...
| **Objavovanie Googlom** | **Indexed 6, Not indexed 0** (30. 8., proti 2 na začiatku) — potvrdené zvonku cez `site:`: anglická domovská, `/sk/`, tri slovenské články a jeden produkt. **Stalo sa to bez sitemapy**: obe majú `Couldn't fetch` a *Last read prázdny*, Google ich nikdy nestiahol, hoci vracajú 200 aj pre Googlebot, platné XML, bez presmerovania. Rozhodnutie #20 (priame vyžiadanie indexovania) = **NASTALO**, rozhodnutie #35 (sitemapa) = **NENASTALO** | ťažisko patrí priamemu vyžiadaniu a odkazom, nie čakaniu na sitemapu; domovská zaradená do prioritnej crawl queue 30. 8., lebo Google na nej ukazoval ponuku z 18. 8. |
