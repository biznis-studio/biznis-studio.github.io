...
SITE_CSS = """
  ...
  * { box-sizing: border-box; }
  ...
  /* Dlzka riadku. Merane 2026-08-16 na 1440px: slovenska stranka mala median
     85 znakov na riadok (22 z 30 odsekov nad 80, maximum 98), anglicka 77.
     Pohodlne citanie je zhruba 45-75; nad 80 sa oko na konci riadku straca a
     hlada zaciatok dalsieho. Obmedzuje sa MIERA TEXTU, nie kontajner - nadpisy,
     karty, tabulky a obrazky maju nadalej celu sirku. */
  main > p, main > ul, main > ol, article.post > p, article.post > ul,
  ...
  /* Mala 'display: grid' bez stlpcov, cize jeden stlpec. Pri 720px to
     preslo, po zosirokom na 1080 (2026-08-16) bola z kazdej karty clanku
     lista cez celu sirku so 135 znakmi na riadok. Rovnake stlpce ako
     .product-grid, aby sa karty spravali rovnako v oboch jazykoch. */
  .post-list {
    display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr));
    gap: 1.15rem; margin-top: 1.25rem;
  }
